...
export const CARD_CATALOG_ID = {
    ...
    PLAGUE_FINALE: 'PLAGUE_FINALE',
    BARRICADE: 'BARRICADE',
    CITADEL_CRUSH: 'CITADEL_CRUSH',
    SHOCKWAVE: 'SHOCKWAVE',
    SHADOW_STEP: 'SHADOW_STEP',
    CHEAP_SHOT: 'CHEAP_SHOT',
    BACKDOOR_EXIT: 'BACKDOOR_EXIT',
    LOADED_DICE: 'LOADED_DICE',
    ADRENALINE: 'ADRENALINE',
    ADRENALINE_RUSH: 'ADRENALINE_RUSH',
    RECYCLE: 'RECYCLE',
    SECOND_WIND: 'SECOND_WIND',
    MARK_THE_VEIN: 'MARK_THE_VEIN',
...
export const CARD_BALANCE_TABLE = {
    ...
    [CARD_CATALOG_ID.EXPLOIT_WEAKNESS]: createCardEntry({
        ...
        inscription: {
            ...
            triggerStatusTypes: ['POISON', 'VULNERABLE', 'WEAK', 'FRAIL'],
            payoff: {
    ...
    [CARD_CATALOG_ID.PLAGUE_FINALE]: createCardEntry({
        name: 'Plague Finale',
        type: CARD_TYPE.SKILL,
        power: 0,
        cost: 2,
    ...
    [CARD_CATALOG_ID.CITADEL_CRUSH]: createCardEntry({
        name: 'Citadel Crush',
        type: CARD_TYPE.ATTACK,
        power: 0,
        cost: 2,
    ...
    [CARD_CATALOG_ID.CHEAP_SHOT]: createCardEntry({
        name: 'Cheap Shot',
        type: CARD_TYPE.ATTACK,
        power: 7,
        cost: 1,
    ...
    [CARD_CATALOG_ID.BACKDOOR_EXIT]: createCardEntry({
        name: 'Backdoor Exit',
        type: CARD_TYPE.SKILL,
        power: 0,
        cost: 0,
    ...
    [CARD_CATALOG_ID.LOADED_DICE]: createCardEntry({
        name: 'Loaded Dice',
        type: CARD_TYPE.ATTACK,
        power: 0,
        cost: 2,
    ...
    [CARD_CATALOG_ID.MARK_THE_VEIN]: createCardEntry({
        name: 'Mark the Vein',
        type: CARD_TYPE.SKILL,
        power: 0,
        cost: 1,
